...
// 
// ----------------------------------------------------------------------------
BEGIN_SHADER(ChromaticAberration, "Chromatic Aberration effect")
...
// ----------------------------------------------------------------------------
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM(SCALE, SHADER_PARAM_TYPE_FLOAT, "1", "")
	END_SHADER_PARAMS
...
// ----------------------------------------------------------------------------
	...
	// ----------------------------------------------------------------------------
		DYNAMIC_STATE
		{
			...
			float c0;
			c0 = params[SCALE]->GetFloatValue();
			
			pShaderAPI->SetPixelShaderConstant(1, &c0, 1, true);
