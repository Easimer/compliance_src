...
STUB_WEAPON_CLASS( weapon_psyarm, WeaponPsyArm, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS(weapon_silenced, WeaponSilenced, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS(weapon_decoy, WeaponDecoy, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS(weapon_flare, WeaponFlare, C_BaseHLCombatWeapon);
#ifdef HL2_EPISODIC
